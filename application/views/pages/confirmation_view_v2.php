...
<div>
    <div>
        <div id="orderNumber">
            <span class="font4x">Your service has been booked.</span><span class="font4x">Order #<?="CSSN-".$booking_details['id']?> </span>
        </div>
        <hr />
            ...
            <div class="breakdownBox">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><span style="font-size: 200%;">Total</span></td>
                        ...
                        <tr style="font-size:200%;">
                            <td>Due TODAY</td>
                            <td colspan="2" align="right"><?='$'.number_format(round($booking_details['service_total']/100*20, 0, PHP_ROUND_HALF_UP), 2, '.', '')?>*</td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
...
<?php if($this->config->item('google_tracking_pixel')):?>
    <!-- Google Code for Customer Paid Conversion Page -->
    <script type="text/javascript">
    /* <![CDATA[ */
    ...
    var google_conversion_label = "OKL_CO-y0W8QycXsmAM";
    ...
    <noscript>
        <div style="display:inline;">
            <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/857416393/?label=OKL_CO-y0W8QycXsmAM&amp;guid=ON&amp;script=0"/>
        </div>
    </noscript>
<?php endif; ?>
