<div>
    ...
    <div>
        ...
        <h2>Welcome to Car Shippers Of America!</h2>
        <p>These terms and conditions outline the rules and regulations for the use of  Car Shippers Of America's Website. <br />
            <span style="text-transform: capitalize;">Car Shippers Of America</span> is located at:<br />
            <address>
                1001 NW 62ND STREET SUITE 203 , <br />
                Ft Lauderdale, Florida 33309<br />
                United States<br />
            </address>
            By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Car Shippers Of America's website if you do not accept all of the terms and conditions stated on this page.
        </p>
        ...
        <h2>Cookies</h2>
        <p>We employ the use of cookies. By using <a href="http://www.carshippersofamerica.com" onclick="__gaTracker('send', 'event', 'outbound-article', 'http://www.carshippersofamerica.com', 'Car Shippers Of America');" title="Car Shippers Of America">Car Shippers Of America</a>'s website you consent to the use of cookies in accordance with Car Shippers Of America’s privacy policy.</p>
        ...
        <h2>License</h2>
        <p>Unless otherwise stated, Car Shippers Of America and/or it’s licensors own the intellectual property rights for all material on Car Shippers Of America All intellectual property rights are reserved. You may view and/or print pages from http://www.carshippersofamerica.com for your own personal use subject to restrictions set in these terms and conditions.</p>
        <p>You must not:</p>
        <ul>
            <li>Republish material from http://www.carshippersofamerica.com</li>
            <li>Sell, rent or sub-license material from http://www.carshippersofamerica.com</li>
            <li>Reproduce, duplicate or copy material from http://www.carshippersofamerica.com</li>
        </ul>
        <p>Redistribute content from Car Shippers Of America (unless content is specifically made for redistribution).</p>

        <h3>User Comments</h3>
        <ol>
            <li>This Agreement shall begin on the date hereof.</li>
            <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information, material and data ('Comments') in areas of the website. Car Shippers Of America does not screen, edit, publish or review Comments prior to their appearance on the website and Comments do not reflect the views or opinions of Car Shippers Of America, its agents or affiliates. Comments reflect the view and opinion of the person who posts such view or opinion. To the extent permitted by applicable laws Car Shippers Of America shall not be responsible or liable for the Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</li>
            <li>Car Shippers Of America reserves the right to monitor all Comments and to remove any Comments which it considers in its absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms and Conditions.</li>
            ...
            <li>You hereby grant to <strong>Car Shippers Of America</strong> a non-exclusive royalty-free license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</li>
        </ol>
        ...
        <p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect unfavorably on us or our accredited businesses (for example, trade associations or other organizations representing inherently suspect types of business, such as work-at-home opportunities, shall not be allowed to link); (b)the organization does not have an unsatisfactory record with us; (c) the benefit to us from the visibility associated with the hyperlink outweighs the absence of Car Shippers Of America; and (d) where the link is in the context of general resource information or is otherwise consistent with editorial content in a newsletter or similar product furthering the mission of the organization.</p>
        ...
        <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must notify us by sending an e-mail to <a href="mailto:info@response1medicalalarm.com" title="send an email to info@response1medicalalarm.com">info@response1medicalalarm.com</a>. Please include your name, your organization name, contact information (such as a phone number and/or e-mail address) as well as the URL of your site, a list of any URLs from which you intend to link to our Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.</p>
