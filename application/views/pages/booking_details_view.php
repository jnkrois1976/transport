<div>
    <div>
        ...
        <div id="orderNumber">
            <span class="font4x">Your booking details</span><span class="font4x">Order #<?="CSSN-".$booking_details['id']?> </span>
        </div>
        <hr />
        <?php if($booking_details['transaction_status'] == 'AUTHORIZED' ): ?>
            ...
            <div>
                <div id="whatNow">
                    <span>
                        <?php $breakDate = explode(" ", $booking_details['order_created']); ?>
                        This booking was created on:<br />
                        <strong class="font2x">
                            <?=date("F jS, Y", strtotime($breakDate[0]))?>
                        </strong>
                    </span>
                    <span>
        ...
        <?php elseif($booking_details['transaction_status'] != 'AUTHORIZED' ): ?>
            <p class="font3x">
                This service request has been cancelled/voided.<br />
            </p>
        <?php endif; ?>
    <?php elseif(!$booking_details): ?>
        <p class="font3x">
            The service number you provided is not valid.<br />
        </p>
        <hr />
        <p>
            Please try again.
        ...
        <form action="/retrieve_quote_details" method="post" class="form-inline">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control input-lg" value="" placeholder="booking number..." name="quoteId" />
            </div>
            <div class="form-group">
